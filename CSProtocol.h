...
#define CS_VETERAN_REQ				(CS_LOGIN + 0x0016)
#define CS_VETERAN_ACK				(CS_LOGIN + 0x0017)
//////////////////////////////////////////////////////////////////////
...
#define CS_ASSISTANT_ACK					(CS_MAP + 0x0261)

#define CS_ASSISTANTANSWER_REQ				(CS_MAP + 0x0262)

#define CS_ASSISTANTRESULT_ACK				(CS_MAP + 0x0263)

#define CS_ASSISTANTADD_ACK					(CS_MAP + 0x0264)

#define CS_ASSISTANTDEL_REQ					(CS_MAP + 0x0265)

#define CS_ASSISTANTDEL_ACK					(CS_MAP + 0x0266)

#define CS_ASSISTANTATTR_ACK				(CS_MAP + 0x0267)

#define CS_ASSISTANTSTAT_ACK				(CS_MAP + 0x0268)

#define CS_LEAVESKYGARDEN_ACK				(CS_MAP + 0x0269)

#define CS_SKYGARDENOCCUPY_ACK				(CS_MAP + 0x0270)

#define CS_SKYGARDEN_OCCUPY_LEFT_ACK		(CS_MAP + 0x0271)

#define CS_SKYGARDEN_OCCUPY_CENTER_ACK		(CS_MAP + 0x0272)

#define CS_SKYGARDEN_OCCUPY_RIGHT_ACK		(CS_MAP + 0x0273)
#define CS_KILLSTATUE_REQ                   (CS_MAP + 0x0274)
#define CS_ENTERBOW_ACK		(CS_MAP + 0x0275)
//////////////////////////////////////////////////////////////////////////
//Apex
...
//#define CS_HACKINFO_REQ						(CS_MAP + 0x0942)
#define CS_WINLDIC_REQ						(CS_MAP + 0x0943)
#define CS_WHIP_ACK							(CS_MAP + 0x0944)
//CUSTOM
#define CS_CHGTITLE_REQ						(CS_MAP + 0x0950)
#define CS_CHGTITLE_ACK						(CS_MAP + 0x0951)
#define CS_TITLELIST_ACK					(CS_MAP + 0x0952)
#define CS_TITLEUPDATE_ACK					(CS_MAP + 0x0953)
#define CS_CHARTITLE_ACK					(CS_MAP + 0x0954)
#define CS_CLOCK_ACK                        (CS_MAP + 0x0F54)
#define CS_GETSADDLE_ACK                    (CS_MAP + 0x0F64)
#define CS_SADDLE_REQ                       (CS_MAP + 0x0F74)
#define CS_SENDSADDLE_ACK                   (CS_MAP + 0x0F84)
#define CS_BOWTICK_ACK                      (CS_MAP + 0x0959)
#define CS_BOWREG_REQ                       (CS_MAP + 0x0960)
#define CS_UPDATELOT_REQ                    (CS_MAP + 0x0961)
#define CS_RESETLOT_REQ                     (CS_MAP + 0x0962)
#define CS_GETLREWARD_REQ                   (CS_MAP + 0x0963)
#define CS_CHECKLOTEND_REQ                  (CS_MAP + 0x0964)
#define CS_WLLOT_REQ                        (CS_MAP + 0x0965)
#define CS_BOWANNOUNCE_ACK                  (CS_MAP + 0x0966)
//END