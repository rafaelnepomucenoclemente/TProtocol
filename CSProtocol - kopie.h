...
#define CS_LOT_ACK					(CS_MAP + 0x0995)
// DWORD dwEXP
// DWORD dwPrevExp
// DWORD dwNextExp
...
#define CS_ADDRECALLJON_ACK					(CS_MAP + 0x0CD9)
// DWORD dwHostID
// DWORD dwMonID
// WORD wTemplateID
// WORD wPetID
...
#define CS_LOT_RESET					    (CS_MAP + 0x0946)
// DWORD dwGold
// DWORD dwGold
// DWORD dwSilver
// DWORD dwCooper
...
#define CS_JETRECALL_REQ					(CS_MAP + 0x1133)
// WORD wPetID
...
#define CS_BATTLEGROUND_ACK					(CS_MAP + 0x01DD)
...
#define CS_ENTERTUTORIAL_ACK				(CS_MAP + 0x0260)
...
#define CS_CLOCK_ACK						(CS_MAP + 0x0985)
#define CS_ENTERSKYGARDENCASTLE_ACK			(CS_MAP + 0x0942)
#define CS_BATTLEGROUNDY_REQ						(CS_MAP + 0x0943)
// BYTE bCommand ( 0:신청, 1:나가기)
// WORD wNpcID
#define CS_WINLDIC_REQ						(CS_MAP + 0x0944)
#define CS_WHIP_ACK						(CS_MAP + 0x0945)
#define CS_KRIDLA_ACK						(CS_MAP + 0x0947)
#define CS_CHGTITLE_REQ                     (CS_MAP + 0x0949)
#define CS_CHGTITLE_ACK                     (CS_MAP + 0x094F)
// BYTE bResult