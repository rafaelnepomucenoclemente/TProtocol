...
#define TVERSION							((WORD) 0x6047)	// Protocol version
...
#define CS_LOGIN							(0x4360)		// Login server <-> Client message base
#define CS_MAP								(0x5330)		// Map server <-> Client message base
